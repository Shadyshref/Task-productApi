...
import { adminMiddleware, auth } from "../middlewares/authMiddleware.js";
 ...
 *       - Product
 *     security:
 *       - BearerAuth: []  # Ensure to include the authorization token
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 */
router.post("/create", auth, adminMiddleware, createProduct);
 ...
 */
router.get("/:id", auth, adminMiddleware, getSingleProduct);
 ...
 */
router.patch("/update/:id", auth, adminMiddleware, updateProduct);
 ...
 *         description: Forbidden.
 */
router.delete("/delete/:id", auth, adminMiddleware, deleteProduct);

/**
 * @swagger
 * /api/product/statistics:
 *   post:
 *     description: Fetch statistics related to products, e.g., sales or quantity.
 *     tags:
 *       - Product
 *     security:
 *       - BearerAuth: []  # Ensure to include the authorization token
